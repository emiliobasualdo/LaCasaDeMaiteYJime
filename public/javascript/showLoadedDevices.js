function showOven(devID) {
    ...
    contenido.append(
        ...
        '                    <a class="btn btn-black-outline display-4" onclick="endRoutine(\'oven\',\'' + devID + '\')"><span class="mbri-success mbr-iconfont mbr-iconfont-btn"></span>FINISH</a></div>' +
        '            </div>' +
        '        </div>' +
        '    </div>' +
        '</section>');
...
function showDoor(devID) {
    ...
    contenido.append(
        ...
        '                    <a class="btn btn-black-outline display-4" onclick="endRoutine(\'door\',\'' + devID + '\')"><span class="mbri-success mbr-iconfont mbr-iconfont-btn"></span>FINISH</a></div>' +
        '            </div>' +
        '        </div>' +
        '    </div>' +
        '</section>');
...
function showAC(devID) {
    ...
    contenido.append(
        ...
        '                    <a class="btn btn-black-outline display-4" onclick="endRoutine(\'ac\',\'' + devID + '\')"><span class="mbri-success mbr-iconfont mbr-iconfont-btn"></span>FINISH</a></div>' +
        '            </div>' +
        '        </div>' +
        '    </div>' +
        '</section>');
...
function showFridge(devID) {
    ...
    contenido.append(
        ...
        '                    <a class="btn btn-black-outline display-4" onclick="endRoutine(\'fridge\',\'' + devID + '\')"><span class="mbri-success mbr-iconfont mbr-iconfont-btn"></span>FINISH</a></div>' +
        '            </div>' +
        '        </div>' +
        '    </div>' +
        '</section>');
...
function showBlinds(devID) {
    ...
    contenido.append(
        ...
        '                    <a class="btn btn-black-outline display-4" onclick="endRoutine(\'blinds\',\'' + devID + '\')"><span class="mbri-success mbr-iconfont mbr-iconfont-btn"></span>FINISH</a></div>' +
        '            </div>' +
        '        </div>' +
        '    </div>' +
        '</section>');
...
function showLights(devID) {
    ...
    contenido.append(
        ...
        '                    <a class="btn btn-black-outline display-4" onclick="endRoutine(\'lights\',\'' + devID + '\')"><span class="mbri-success mbr-iconfont mbr-iconfont-btn"></span>FINISH</a></div>' +
        '            </div>' +
        '        </div>' +
        '    </div>' +
        '</section>');
